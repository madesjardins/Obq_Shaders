...
def Obq_MessageGetColorHelpURL():
	# Add the Obq_Shader docs URL to the Attribute Editor help menu
	ObqNodeType = 'Obq_MessageGetColor'
	ObqNodeHelpURL = 'https://github.com/madesjardins/Obq_Shaders/wiki/Obq_MessageGet'
	ObqHelpCommand = 'addAttributeEditorNodeHelp("' + ObqNodeType + '", "showHelp -absolute \\"' +ObqNodeHelpURL +'\\"");'
	mel.eval(ObqHelpCommand)

class AEObq_MessageGetColorTemplate(ShaderAETemplate):
	...
	def setup(self):
		...
		#pm.picture(image='Obq_shader_header.png', parent="AttrEdObq_MessageGetColorFormLayout")
		Obq_MessageGetColorHelpURL()
