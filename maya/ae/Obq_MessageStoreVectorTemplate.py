...
def Obq_MessageStoreVectorHelpURL():
	# Add the Obq_Shader docs URL to the Attribute Editor help menu
	ObqNodeType = 'Obq_MessageStoreVector'
	ObqNodeHelpURL = 'https://github.com/madesjardins/Obq_Shaders/wiki/Obq_MessageStore'
	ObqHelpCommand = 'addAttributeEditorNodeHelp("' + ObqNodeType + '", "showHelp -absolute \\"' +ObqNodeHelpURL +'\\"");'
	mel.eval(ObqHelpCommand)

class AEObq_MessageStoreVectorTemplate(ShaderAETemplate):
	...
	def setup(self):
		...
		#pm.picture(image='Obq_shader_header.png', parent="AttrEdObq_MessageStoreVectorFormLayout")
		Obq_MessageStoreVectorHelpURL()
