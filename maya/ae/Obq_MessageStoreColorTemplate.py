...
class AEObq_MessageStoreColorTemplate(ShaderAETemplate):
	...
	def setup(self):
		...
		#pm.picture(image='Obq_shader_header.png', parent="AttrEdObq_MessageStoreColorFormLayout")
		Obq_MessageStoreColorHelpURL()
