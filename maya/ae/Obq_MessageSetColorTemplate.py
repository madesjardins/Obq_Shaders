...
class AEObq_MessageSetColorTemplate(ShaderAETemplate):
	...
	def setup(self):
		...
		#pm.picture(image='Obq_shader_header.png', parent="AttrEdObq_MessageSetColorFormLayout")
		Obq_MessageSetColorHelpURL()
