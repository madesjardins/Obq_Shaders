...
class AEObq_MessageGetIntTemplate(ShaderAETemplate):
	...
	def setup(self):
		...
		#pm.picture(image='Obq_shader_header.png', parent="AttrEdObq_MessageGetIntFormLayout")
		Obq_MessageGetIntHelpURL()
