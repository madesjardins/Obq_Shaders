...
class AEObq_MessageStoreBoolTemplate(ShaderAETemplate):
	...
	def setup(self):
		...
		#pm.picture(image='Obq_shader_header.png', parent="AttrEdObq_MessageStoreBoolFormLayout")
		Obq_MessageStoreBoolHelpURL()
